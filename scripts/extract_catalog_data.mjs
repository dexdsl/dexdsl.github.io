...
const OUT_DATA_PATH = path.join(ROOT, 'data', 'catalog.data.json');
const OUT_ENTRIES_PATH = path.join(ROOT, 'data', 'catalog.entries.json');
const OUT_GUIDE_PATH = path.join(ROOT, 'data', 'catalog.guide.json');
const OUT_SYMBOLS_PATH = path.join(ROOT, 'data', 'catalog.symbols.json');
const OUT_SEARCH_PATH = path.join(ROOT, 'data', 'catalog.search.json');
const OUT_CATALOG_CURATION_SNAPSHOT_PATH = path.join(ROOT, 'data', 'catalog.curation.snapshot.json');
const OUT_HOME_FEATURED_SNAPSHOT_PATH = path.join(ROOT, 'data', 'home.featured.snapshot.json');
