(function () {
  ...
  const ensureEntryRuntimeLayoutOverrides = () => {
    ...
    style.textContent = `
      ...
      /* Click-to-load YouTube facade (privacy phase 2 — dx-video-embed.js).
         Self-sizing 16:9 poster button that replaces the live iframe until the
         visitor activates it. Scoped + !important to beat the generic button
         reset in dx-controls.css (inline-flex / min-height / border-radius). */
      body.dx-entry-page .dex-video-facade {
        position: relative !important;
        ...
        padding: 0 !important;
        border: 0 !important;
        border-radius: var(--dx-entry-card-radius, 6px) !important;
      ...
      body.dx-entry-page .dex-video-facade::before {
        content: "" !important;
        position: absolute !important;
        inset: 0 !important;
        background: linear-gradient(180deg, rgba(0, 0, 0, 0.12) 0%, rgba(0, 0, 0, 0) 32%, rgba(0, 0, 0, 0.45) 100%) !important;
        transition: background 0.24s ease !important;
        pointer-events: none !important;
      }

      body.dx-entry-page .dex-video-facade:hover::before,
      body.dx-entry-page .dex-video-facade:focus-visible::before {
        background: linear-gradient(180deg, rgba(0, 0, 0, 0.24) 0%, rgba(0, 0, 0, 0.08) 40%, rgba(0, 0, 0, 0.55) 100%) !important;
      }

      body.dx-entry-page .dex-video-facade:focus-visible {
        outline: 3px solid var(--dx-accent-solid, #ff4d2e) !important;
        outline-offset: -3px !important;
      }

      body.dx-entry-page .dex-video-play {
        position: absolute !important;
        top: 50% !important;
        left: 50% !important;
      ...
      body.dx-entry-page .dex-video-play::after {
        content: "" !important;
        position: absolute !important;
        top: 50% !important;
        left: 52% !important;
      ...
      body.dx-entry-page .dex-video-facade:hover .dex-video-play,
      body.dx-entry-page .dex-video-facade:focus-visible .dex-video-play {
        transform: translate(-50%, -50%) scale(1.08) !important;
        background: var(--dx-accent-solid, #ff4d2e) !important;
      }

      body.dx-entry-page .dex-video-facade-label {
        position: absolute !important;
        left: clamp(8px, 1.4vw, 16px) !important;
        bottom: clamp(8px, 1.4vw, 16px) !important;
        max-width: calc(100% - 2 * clamp(8px, 1.4vw, 16px)) !important;
      ...
      /* Lookup-number fit guard: cap the nowrap flex span to its sidebar cell so
         the JS auto-fit (fitOverviewLookupText) measures the true available width
         and shrinks the number correctly instead of overflowing. */
