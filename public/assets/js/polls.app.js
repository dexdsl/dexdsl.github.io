(()=>{(()=>{if(typeof window=="undefined"||typeof document=="undefined")return;if(window.__dxPollsAppLoaded&&typeof window.__dxPollsQueueBoot=="function"){try{window.__dxPollsQueueBoot()}catch{}return}window.__dxPollsAppLoaded=!0;let z="dx-polls-app-style-v2",L=120,J=16,W=10,Y=12,A="open",ee=new Set(["open","results","archive"]),te=45e3,o={tab:A,pollId:"",closedPage:1,archiveDrawerOpen:!1,authSnapshot:{auth:null,authenticated:!1,token:null,user:null},collections:{open:{polls:[],page:1,pages:1,total:0},closed:{polls:[],page:1,pages:1,total:0},published:{rows:[],page:1,pages:1,total:0}},detail:null,detailCache:new Map,loading:!1,error:"",busyVote:!1};function r(e){return String(e!=null?e:"").trim()}function i(e){return String(e!=null?e:"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function T(e){let t=String(e||"/").replace(/\/+/g,"/");return t==="/"?"/":t.endsWith("/")?t.slice(0,-1):t}function S(e){let t=r(e).toLowerCase();return ee.has(t)?t:A}function D(e=null){let t=new URLSearchParams(window.location.search||""),l=r(t.get("poll")),a=S(t.get("tab"));if(e instanceof Element){let n=r(e.getAttribute("data-dx-poll-id"));n&&!l&&(l=n,a="open")}let s=T(window.location.pathname||"/");if(s.startsWith("/polls/")){let n=s.slice(7).replace(/\/index\.html$/i,"").replace(/\/$/,"");n&&(l=decodeURIComponent(n),a="open")}return{tab:a,pollId:l}}function y(e,t=""){let l=new URLSearchParams,a=S(e),s=r(t);if(a==="open"&&s)return`/polls/${encodeURIComponent(s)}/`;a!==A&&l.set("tab",a),s&&l.set("poll",s);let n=l.toString();return`/polls/${n?`?${n}`:""}`}function N({tab:e,pollId:t},l=!1){let a=y(e,t),s=a.replace(/\/index\.html$/,"/");`${window.location.pathname}${window.location.search}`!==s&&(l?window.history.replaceState({},"",a):window.history.pushState({},"",a))}function k(e){let t=Date.parse(String(e||""));return Number.isFinite(t)?t:null}function x(e){let t=k(e);if(!t)return"TBD";try{return new Date(t).toLocaleString(void 0,{year:"numeric",month:"short",day:"numeric"})}catch{return new Date(t).toISOString().slice(0,10)}}function R(e){let t=k(e);if(!t)return"Closing date TBD";let l=t-Date.now();if(l<=0)return"Closed";let a=Math.floor(l/36e5),s=Math.floor(a/24),n=a%24;return s>0?`${s}d ${n}h left`:a>0?`${a}h left`:`${Math.max(1,Math.floor(l/6e4))}m left`}function le(e){return Array.isArray(e)?e.map(t=>r(t)).filter(Boolean):typeof e=="string"?e.split("|").map(t=>r(t)).filter(Boolean):[]}function m(e){let t=e&&typeof e=="object"?e:{};return{id:r(t.id),slug:r(t.slug)||null,status:r(t.status)||"draft",question:r(t.question)||"Untitled poll",options:le(t.options),createdAt:r(t.createdAt||t.created_at),closeAt:r(t.closeAt||t.close_at),manualClose:!!(t.manualClose||t.manual_close),visibility:r(t.visibility)==="members"?"members":"public",closed:!!t.closed}}function oe(e){let t={};if(!e||typeof e!="object")return t;for(let[l,a]of Object.entries(e)){let s=Number(a);!Number.isFinite(s)||s<0||(t[String(l)]=Math.floor(s))}return t}function ae(e){let t=e&&typeof e=="object"?e:{};return{total:Math.max(0,Number(t.total||0)||0),counts:Array.isArray(t.counts)?t.counts.map(l=>Math.max(0,Number(l)||0)):oe(t.counts),viewerVote:Number.isInteger(Number(t.viewerVote))?Number(t.viewerVote):null,closed:!!t.closed,mode:r(t.mode||"live")||"live",publishedSnapshot:t.publishedSnapshot&&typeof t.publishedSnapshot=="object"?t.publishedSnapshot:null}}function q(e,t=1){if(Array.isArray(e))return{polls:e.map(m),page:t,pages:1,total:e.length};let l=e&&typeof e=="object"?e:{},s=[l.polls,l.items,l.data,l.rows].find(n=>Array.isArray(n))||[];return{polls:s.map(m),page:Math.max(1,Number(l.page)||t),pages:Math.max(1,Number(l.pages||l.totalPages)||1),total:Math.max(0,Number(l.total||l.count||s.length)||0)}}function se(e){let t=e&&typeof e=="object"?e:{},l=Array.isArray(t.items)?t.items:Array.isArray(t.rows)?t.rows:Array.isArray(t.polls)?t.polls:[];return{rows:l.map(a=>{let s=a!=null&&a.poll&&typeof a.poll=="object"?a.poll:a,n=a!=null&&a.publishedSnapshot&&typeof a.publishedSnapshot=="object"?a.publishedSnapshot:a!=null&&a.snapshot&&typeof a.snapshot=="object"?a.snapshot:null;return{poll:m(s),snapshot:n}}),page:Math.max(1,Number(t.page)||1),pages:Math.max(1,Number(t.pages||t.totalPages)||1),total:Math.max(0,Number(t.total||t.count||l.length)||0)}}function ne(e){let t=e&&typeof e=="object"?e:{},l=t.trend&&typeof t.trend=="object"?t.trend:t;return(Array.isArray(l.series)?l.series:Array.isArray(l.points)?l.points:[]).map(s=>{var n,d,p;return{t:r(s.t||s.bucket||s.timestamp||s.date||s.label),value:Math.max(0,Number((p=(d=(n=s.value)!=null?n:s.count)!=null?d:s.total)!=null?p:0)||0)}}).filter(s=>s.t)}function B(e=[]){let t="\u2581\u2582\u2583\u2584\u2585\u2586\u2587\u2588";if(!Array.isArray(e)||e.length===0)return"";let l=e.map(s=>Math.max(0,Number(s.value)||0)),a=Math.max(...l,0);return a<=0?"\u2581".repeat(l.length):l.map(s=>{let n=s/a,d=Math.max(0,Math.min(t.length-1,Math.round(n*(t.length-1))));return t[d]}).join("")}function j(e){if(!e||e.status==="closed"||e.manualClose||e.closed)return!0;let t=k(e.closeAt);return t?t<=Date.now():!1}function ie(){return r(window.DEX_API_BASE_URL||window.DEX_API_ORIGIN||"https://dex-api.spring-fog-8edd.workers.dev").replace(/\/$/,"")}async function U(){let e=window.DEX_AUTH||window.dexAuth||null;if(!e)return{auth:null,authenticated:!1,token:null,user:null};try{typeof e.resolve=="function"?await e.resolve(2400):e.ready&&typeof e.ready.then=="function"&&await e.ready}catch{}let t=!1;try{typeof e.isAuthenticated=="function"&&(t=!!await e.isAuthenticated())}catch{}let l=null;if(t&&typeof e.getAccessToken=="function")try{l=await e.getAccessToken()}catch{l=null}let a=null;try{typeof e.getUser=="function"&&(a=await e.getUser())}catch{}return{auth:e,authenticated:t,token:l,user:a}}async function O(){var e;if(!(!((e=o.authSnapshot)!=null&&e.auth)||typeof o.authSnapshot.auth.signIn!="function"))try{await o.authSnapshot.auth.signIn({returnTo:`${window.location.pathname}${window.location.search}${window.location.hash}`})}catch{}}async function u(e,{method:t="GET",body:l=null,authRequired:a=!1}={}){var p;let s={accept:"application/json"};if(l!=null&&(s["content-type"]="application/json"),(p=o.authSnapshot)!=null&&p.token&&(s.authorization=`Bearer ${o.authSnapshot.token}`),a&&!s.authorization)return{ok:!1,status:401,data:{error:"AUTH_REQUIRED"}};let n=await fetch(`${ie()}${e}`,{method:t,headers:s,body:l==null?void 0:JSON.stringify(l)}),d=null;try{d=await n.json()}catch{d=null}return{ok:n.ok,status:n.status,data:d}}function P(e,t){e.setAttribute("data-dx-fetch-state",t),t==="loading"?e.setAttribute("aria-busy","true"):e.removeAttribute("aria-busy")}let H=`
      ...
      </div>`;function re(){if(document.getElementById(z))return;let e=document.createElement("style");e.id=z,e.textContent=`
      .dx-polls-shell{
    ...
    `,document.head.appendChild(e)}function E(){return document.querySelector("[data-dx-polls-app]")||document.getElementById("dx-polls-app")||document.getElementById("dex-console")}function de(e,t){e.innerHTML=`
      ${H}
    ...
    `}function V(e,{includeTrend:t=!1}={}){let l=j(e),a=e.visibility==="members"&&!o.authSnapshot.authenticated,s=y(o.tab,e.id),n=t&&Array.isArray(e.__trendPoints)&&e.__trendPoints.length?`<p class="dx-poll-trend">90d trend</p><p class="dx-poll-trend-line">${i(B(e.__trendPoints))}</p>`:"";return`
      <article class="dx-poll-card${a?" is-locked":""}" data-dx-poll-id="${i(e.id)}">
        ...
        <p class="dx-poll-meta">${l?`Closed ${i(x(e.closeAt))}`:`Closes ${i(x(e.closeAt))} (${i(R(e.closeAt))})`}</p>
        ${n}
    ...
    `}function pe(e){var p;let t=e.poll||m({}),l=e.snapshot&&typeof e.snapshot=="object"?e.snapshot:null,a=Number((l==null?void 0:l.total)||((p=l==null?void 0:l.totals)==null?void 0:p.total)||0)||0,s=r((l==null?void 0:l.headline)||""),n=r((l==null?void 0:l.summaryMarkdown)||(l==null?void 0:l.summary)||""),d=r((l==null?void 0:l.publishedAt)||(l==null?void 0:l.published_at));return`
    ...
    `}function ce(e){if(!e)return`
      ...
      `;let t=e.poll,l=e.results,a=j(t)||!!l.closed,s=Array.isArray(l.counts)?l.counts:t.options.map((b,c)=>{var g,v,C,Z;return Number((Z=(C=(g=l.counts)==null?void 0:g[String(c)])!=null?C:(v=l.counts)==null?void 0:v[c])!=null?Z:0)}),n=t.options.map((b,c)=>{let g=Math.max(0,Number(s[c])||0),v=l.total>0?Math.round(g/l.total*100):0;return`
      ...
      <div class="dx-polls-detail">
        ...
        <p class="dx-poll-meta">${a?`Closed ${i(x(t.closeAt))}`:`Closes ${i(x(t.closeAt))} \xB7 ${i(R(t.closeAt))}`}</p>
    ...
    `}function _(e){let t=o.collections.open.polls.length?o.collections.open.polls.map(n=>V(n)).join(""):'<p class="dx-polls-empty">No open polls right now.</p>',l=o.collections.closed.polls.length?o.collections.closed.polls.map(n=>V(n,{includeTrend:!0})).join(""):'<p class="dx-polls-empty">No closed polls in this window.</p>',a=o.collections.published.rows.length?o.collections.published.rows.map(n=>pe(n)).join(""):'<p class="dx-polls-empty">No published snapshots yet.</p>',s=o.tab==="open"?`
      ...
      <section class="dx-polls-shell${o.loading?" dx-polls-loading":""}">
        ...
        <div class="dx-polls-body">
          ...
          <aside class="dx-polls-col dx-polls-col--detail">${ce(o.detail)}</aside>
        </div>
      </section>
    `}async function ue(){let[e,t,l]=await Promise.all([u(`/polls?state=open&page=1&pageSize=${J}`),u(`/polls?state=closed&page=${o.closedPage}&pageSize=${W}`),u(`/polls/published?page=1&pageSize=${Y}`)]);if(!e.ok)throw new Error("Unable to load open polls");if(!t.ok)throw new Error("Unable to load closed polls");o.collections.open=q(e.data,1),o.collections.closed=q(t.data,o.closedPage),o.collections.published=l.ok?se(l.data):{rows:[],page:1,pages:1,total:0},o.closedPage=o.collections.closed.page}async function Q(e){try{let t=await u(`/polls/${encodeURIComponent(e)}/trend?bucket=day&window=90d`);return t.ok?ne(t.data):[]}catch{return[]}}async function F(e){var b,c;let t=r(e);if(!t){o.detail=null;return}let l=o.detailCache.get(t);if(l&&Date.now()-l.cachedAt<=te&&!o.busyVote){o.detail=l.value;return}let a=await u(`/polls/${encodeURIComponent(t)}`);if(a.status===401||a.status===403){o.detail={locked:!0,pollId:t};return}if(!a.ok)throw new Error(`Unable to load poll ${t}`);let s=m(((b=a.data)==null?void 0:b.poll)||a.data),n=await u(`/polls/${encodeURIComponent(t)}/results`);if(!n.ok)throw new Error(`Unable to load poll results (${t})`);let d=ae(((c=n.data)==null?void 0:c.results)||n.data),p=await Q(t),$={locked:!1,poll:s,results:d,trend:p};o.detail=$,o.detailCache.set(t,{cachedAt:Date.now(),value:$})}async function xe(e){if(!(!o.detail||o.detail.locked||o.busyVote)&&!(!Number.isInteger(e)||e<0)){if(o.authSnapshot=await U(),!o.authSnapshot.authenticated){await O();return}o.busyVote=!0;try{let t=o.detail.poll.id;if(!(await u(`/polls/${encodeURIComponent(t)}/vote`,{method:"POST",authRequired:!0,body:{optionIndex:e}})).ok)throw new Error("Vote failed");o.detailCache.delete(t),await F(t)}finally{o.busyVote=!1}}}function M(e){e.querySelectorAll("[data-dx-polls-tab]").forEach(s=>{s.addEventListener("click",async()=>{let n=S(s.getAttribute("data-dx-polls-tab"));n!==o.tab&&(o.tab=n,o.error="",N({tab:o.tab,pollId:o.pollId},!1),await w(e))})}),e.querySelectorAll("[data-dx-poll-signin]").forEach(s=>{s.addEventListener("click",async n=>{n.preventDefault(),await O()})}),e.querySelectorAll("[data-dx-poll-vote]").forEach(s=>{s.addEventListener("click",async()=>{let n=Number(s.getAttribute("data-dx-poll-vote"));await xe(n),_(e),M(e)})});let t=e.querySelector("[data-dx-polls-archive-drawer]");t&&t.addEventListener("toggle",()=>{o.archiveDrawerOpen=!!t.open});let l=e.querySelector("[data-dx-poll-closed-prev]");l&&l.addEventListener("click",async()=>{o.closedPage<=1||(o.closedPage-=1,await w(e))});let a=e.querySelector("[data-dx-poll-closed-next]");a&&a.addEventListener("click",async()=>{o.closedPage+=1,await w(e)})}async function fe(){if(o.tab!=="archive")return;let e=o.collections.closed.polls.slice(0,3);e.length&&await Promise.all(e.map(async t=>{if(!t.id)return;let l=await Q(t.id);t.__trendPoints=l}))}async function w(e){o.loading=!0,_(e),M(e);try{await ue(),await fe(),await F(o.pollId),o.error=""}catch(t){o.error=t instanceof Error?t.message:String(t)}finally{o.loading=!1,_(e),M(e)}}async function X(e){let t=performance.now()-e;t>=L||await new Promise(l=>window.setTimeout(l,L-t))}async function me(){let e=E();if(!e)return;re();let t=performance.now();P(e,"loading");let l=D(e);o.tab=l.tab,o.pollId=l.pollId,N({tab:o.tab,pollId:o.pollId},!0);try{o.authSnapshot=await U(),await w(e),await X(t),P(e,"ready")}catch(a){console.error("[dx-polls] boot error",a),de(e,"Unable to load polls right now. Please try again."),await X(t),P(e,"error")}}let f=null,I=!1,G="";function K(){let e=D(E()),t=T(window.location.pathname||"/"),l=r(window.location.search||"");return`${t}?${l}|${e.tab}|${e.pollId}`}async function he(){do I=!1,await me(),G=K();while(I)}function h(){if(!f){let e=E();if(e&&e.getAttribute("data-dx-fetch-state")==="ready"&&K()===G)return Promise.resolve()}return f?(I=!0,f):(f=he().catch(e=>{console.error("[dx-polls] queue boot error",e)}).finally(()=>{f=null}),f)}window.__dxPollsQueueBoot=h,window.addEventListener("dx:slotready",()=>{h().catch(()=>{})},{once:!0}),window.addEventListener("popstate",()=>{h().catch(()=>{})}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{h().catch(()=>{})},{once:!0}):h().catch(()=>{})})();})();
